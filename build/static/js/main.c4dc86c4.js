/*! For license information please see main.c4dc86c4.js.LICENSE.txt */
!(function () {
  ...
  var e = {
      ...
      463: function (e, t, n) {
        ...
        function di() {
          return 0 !== (48 & zu) ? Wl() : -1 !== ui ? ui : (ui = Wl());
        }
        function pi(e) {
        ...
        function Pi(e, t) {
          ...
          if ((na(), (zu = n), (Lu.current = r), null !== Mu))
            throw Error(o(261));
        ...
        var ic = { Events: [rl, ll, al, Oe, ze, Ii, { current: !1 }] },
          cc = {
  ...
  !(function () {
    ...
    function y(t) {
      ...
      var g = P(r),
        y = (0, e.useMemo)(
          function () {
            return { basename: g, navigator: s, static: d };
          },
          [g, s, d]
        );
      ...
      var b = u,
        ...
        L = void 0 === T ? null : T,
        O = b.key,
        z = void 0 === O ? "default" : O,
        R = (0, e.useMemo)(
          function () {
            var e = _(S, g);
            return null == e
              ? null
              : { pathname: e, search: x, hash: N, state: L, key: z };
          },
          [g, S, x, N, L, z]
        );
      return null == R
    ...
    function b(t) {
      ...
      return l.createHref({ pathname: c, search: i, hash: o });
    }
    function w() {
      return null != (0, e.useContext)(v);
    }
    function k() {
      return w() || h(!1), (0, e.useContext)(v).location;
    }
    function S() {
      w() || h(!1);
        ...
        (0, e.useCallback)(
          function (e, t) {
            if ((void 0 === t && (t = {}), u.current))
              if ("number" !== typeof e) {
                var l = x(e, JSON.parse(o), a);
                "/" !== n && (l.pathname = C([n, l.pathname])),
    ...
    function x(e, t, n) {
      var r,
        l = "string" === typeof e ? p(e) : e,
        a = "" === e || "" === l.pathname ? "/" : l.pathname;
      if (null == a) r = n;
      else {
        var o = t.length - 1;
        if (a.startsWith("..")) {
          for (var u = a.split("/"); ".." === u[0]; ) u.shift(), (o -= 1);
          l.pathname = u.join("/");
        }
        r = o >= 0 ? t[o] : "/";
      }
      var i = (function (e, t) {
        ...
        var n = "string" === typeof e ? p(e) : e,
          ...
          i = r
            ...
            : t;
        return { pathname: i, search: N(a), hash: T(u) };
      })(l, r);
      return (
        a &&
          "/" !== a &&
    ...
    function R(t) {
      ...
      null == h.current &&
        (h.current = (function (e) {
          ...
          return (
            null == y &&
              ((y = 0), m.replaceState(a({}, m.state, { idx: y }), "")),
            {
              get action() {
                return g;
              },
              ...
              push: function e(t, a) {
                ...
                if (
                  ...
                  var c = [{ usr: i.state, key: i.key, idx: y + 1 }, n(i)];
                  (i = c[0]), (c = c[1]);
                  try {
                    m.pushState(i, "", c);
                  } catch (s) {
              ...
              block: function (e) {
                var t = k.push(e);
                return (
                  1 === k.length && h.addEventListener("beforeunload", c),
                  function () {
                    t(), k.length || h.removeEventListener("beforeunload", c);
                  }
                );
              },
            }
      ...
      var m = h.current,
        v = l((0, e.useState)({ action: m.action, location: m.location }), 2),
        g = v[0],
        b = v[1];
      return (
        (0, e.useLayoutEffect)(
    ...
    var M = (0, e.forwardRef)(function (t, n) {
      var r = t.onClick,
        l = t.reloadDocument,
        a = t.replace,
        o = void 0 !== a && a,
        ...
        })(c, { replace: o, state: u, target: i });
      return (0, e.createElement)(
        "a",
        L({}, s, {
          href: f,
          onClick: function (e) {
            r && r(e), e.defaultPrevented || l || p(e);
          },
          ref: n,
          target: i,
        })
      ...
      D = function () {
        return (0, I.jsxs)("nav", {
          children: [
            ...
            (0, I.jsx)(M, { to: "/1", children: "1-\u044f" }),
            (0, I.jsx)(M, { to: "/2", children: "2-\u044f" }),
            (0, I.jsx)(M, { to: "/3", children: "3-\u044f" }),
          ],
        });
      };
    function F() {
      return (0, I.jsx)("header", { children: (0, I.jsx)(D, {}) });
    }
    function U() {
      return (0, I.jsx)(F, {});
    }
    t.render(
      (0, I.jsx)(e.StrictMode, {
        children: (0, I.jsx)(R, { children: (0, I.jsx)(U, {}) }),
      }),
      document.getElementById("root")
    );
  })();
})();
//# sourceMappingURL=main.c4dc86c4.js.map
